...
const Toast = ({ message, type = "error", duration = 5000, onClose }) => {
	...
	const getToastStyles = () => {
		...
		if (type === "success") {
			return `${baseStyles} border-green-500 bg-green-900`;
		} else if (type === "warning") {
			return `${baseStyles} border-yellow-500 bg-yellow-900`;
		} else {
			return `${baseStyles} border-red-500 bg-red-900`;
		}
	};
			...
			<div className="flex items-start p-4">
				...
				<div className="ml-4 flex-shrink-0">
					<button
						...
						className="inline-flex text-gray-400 hover:text-gray-200 focus:outline-none cursor-pointer"
					>
